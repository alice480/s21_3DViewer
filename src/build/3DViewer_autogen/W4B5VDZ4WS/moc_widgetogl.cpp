...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_WidgetOGL_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_WidgetOGL_t qt_meta_stringdata_WidgetOGL = {
    {
QT_MOC_LITERAL(0, 9) // "WidgetOGL"
...
const QMetaObject WidgetOGL::staticMetaObject = { {
    ...
    qt_meta_stringdata_WidgetOGL.offsetsAndSize,
    qt_meta_data_WidgetOGL,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_WidgetOGL_t
, QtPrivate::TypeAndForceComplete<WidgetOGL, std::true_type>
